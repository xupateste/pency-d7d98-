...
const chat = ({}) => {
  ...
  function formatWP(code) {
    return 'https://wa.me/51935687208?text=Buenos días🤩%0D%0AConfirmo mi registro ('+code+').';
  }
      ...
      >
        ...
        <Stack mt={-6} alignItems="center" textAlign="center">
          ...
          <InputGroup zIndex={3} mt={-5} >
            ...
            <Input fontSize="4xl" placeholder='D16G' onChange={handleChange} value={message} type="text" maxLength={5} maxWidth={150}/>
          </InputGroup>
        </Stack>
      </Stack>
    </Box>
